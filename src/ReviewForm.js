  ...
  return (
    <React.Fragment>
      ...
      <div>
        ...
        >
          You can always change or cancel your appointment up-to 48 hours to your appointment with ease through your patient portal
        </Alert>
      </div>
      </Fade>
              ...
              <div>
                <ul className={classes.ul}>
                  ...
                  <li className={classes.li}>
                    ...
                    <span className={classes.infoDataPrice}> £100 </span>
                    <span
                      style={{
                        color: "#777",
                        padding: "10px",
                    ...
                    >
                      will go towards your treatment also refundable if you
                      cancel before 48 hours to your appointment,{" "}
                    </span>
                  </li>
                </ul>
              </div>
